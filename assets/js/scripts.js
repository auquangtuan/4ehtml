    ...
    if ($count.exists()) {
      $count.each(function () {
        ...
        $self.countdown(datetime).on("update.countdown", function (event) {
          $(this).html(
            event.strftime(
              '<div class="countdown-item"><span class="countdown-time countdown-time-first text_intro">%D</span><span class="countdown-text text_intro">' +
                _day_text +
                "</span></div>" +
                '<div class="countdown-item"><span class="countdown-time text_intro">%H</span><span class="countdown-text text_intro">' +
                _hour_text +
                "</span></div>" +
                '<div class="countdown-item"><span class="countdown-time text_intro">%M</span><span class="countdown-text text_intro">' +
                _min_text +
                "</span></div>" +
                '<div class="countdown-item"><span class="countdown-time countdown-time-last text_intro">%S</span><span class="countdown-text text_intro">' +
                _sec_text +
                "</span></div>"
            )
          );
